...
scriptDirectory = "/Users/dinobecaj/Documents/ComputerScienceMS/LyonsWork/MLRA/fileLists/"
        
g = open(scriptDirectory+"cppRepositoryList.csv", "a")
...
g = open(scriptDirectory+"pyRepositoryList.csv", "a")
...
g = open(scriptDirectory+"jsRepositoryList.csv", "a")
